# Unit 5 Challenge: The High-Score Tracker Game
...
# 3. If they type the word “stop” (clean it up with .strip().lower()), print “Game session ended!”
# and use a break statement to shut down the loop.
# 4. Otherwise, cast their input into an int, check if the score is greater than 100, and
# print either “Wow! That’s a new high score!” or “Good try, keep playing!” based on the value.
