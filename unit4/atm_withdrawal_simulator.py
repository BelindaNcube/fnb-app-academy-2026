# Unit 4 Challenge: The Smart ATM Withdrawal Simulator
...
# 4. But what if they try to withdraw a negative amount or zero? Add an elif statement checking if the request is
# less than or equal to 0. If so, print: “Invalid amount”. You must withdraw more than “R0”.
# 5. Otherwise (else), print: “Declined. Insufficient funds”

balance = 500

withdrawal_amount = float(input("Enter the amount you would like to withdraw: R"))
